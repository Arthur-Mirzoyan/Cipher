...
import { nextLetter, superMix } from '../../helpers/cipher';
import { FontAwesome5 } from '@expo/vector-icons';

export function EncryptionScreen({ navigation, route }) {
        ...
        <View style={styles.main}>
            ...
            <ScrollView contentContainerStyle={styles.scrollView}>
                ...
                <FontAwesome5
                    ...
                    style={styles.copy}
                    onPress={() => {
                        Clipboard.setString(type == 'super' ? superMix(input, spacing) : nextLetter(input, spacing));
                        Alert.alert(
                            'Success',
                ...
                />
                <Text multiline={true} style={styles.output}>{type == 'super' ? superMix(input, spacing) : nextLetter(input, spacing)}</Text>
            </ScrollView>
        </View>
    )
}